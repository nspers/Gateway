...
export default {
    ...
    methods:{
        updataList(){
            var self = this
            this.loading = true
            this.$api.get('sysDevice/selectSponList/').then(function(res){
                self.data1 = res.data
                self.loading = false
            })
        },
        ...
        remove(){
            ...
            this.$api.delete('sysDevice/delectSpon/' + this.data1[index].id).then(function(res){
                self.updataList()
        ...
        submitUser(){
            ...
            this.$refs.formValidate.validate((valid) => {
                if (valid) {
                    if(this.edit){
                        this.$api.put('sysDevice/updateSpon',this.useData).then(function(res){
                            console.log(res);
                            self.edit = false
                            self.showData = false
                            self.updataList()
                        ...
                        this.$api.post('sysDevice/saveSpon',this.useData).then(function(res){
                            self.showData = false
                            self.updataList()
                        })                
                    }
